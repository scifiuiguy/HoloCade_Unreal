# HoloCade Universal Shield

**Also known as:** HCUS, Uni-Shield

## Overview

<img src="../../../Source/images/HCUS.png" width="100%">

**Plug-n-Play Embedded Systems - an Absolute Necessity for Next-Level LBE:**

The HoloCade Universal Shield ("HCUS" or "Uni-Shield") is a multi-platform ECU that provides unified connectivity and control for all HoloCade firmware applications. But what is it for? What does it do? ECU? What the heck is even that?
...
<details>
<summary><strong>The HCUS Fixes That!</strong></summary>

<div style="margin-left: 20px;">

HCUS is open-source. It's near free! And it's already fully built and running, ready for you to take and use and skin it with new assets and stand up a new LBE event in a fraction of the time!

HCUS fully integrated with both major game engines (Unity/Unreal) in a ready-to-play local multiplayer server project that has a bunch of LBE templates ready-to-play. A single out-of-the-box HCUS has a bill-of-materials of less than $200 to build 5 copies. HoloCade is not a company. The PCB files are in the git repo, ready for you to send to any PCB manufacturer to order boards at a tiny fraction of the cost of using PLCs. A single HCUS unit supports 8 simultaneous child ECUs via Ethernet while providing galvanically isolated CAN-FD connectivity for high-current device control.
...
The industry needs standard specs. If you already built a hydraulic rig to a known spec, and EVERY VR dev team knows that spec already, they can ALL starting building experiences for it. It's a chicken/egg challenge, and neither can happen first until we have a spec. That's why HCUS is critical for VR2.0.
