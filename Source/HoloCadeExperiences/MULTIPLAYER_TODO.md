...
class HOLOCADEEXPERIENCES_API AAIFacemaskExperience : public AHoloCadeExperienceBase
{
    ...
    UPROPERTY(Replicated, BlueprintReadOnly, Category = "HoloCade|AI Facemask")
...
**File:** Create new `HoloCadePlayerController.h/cpp`

```cpp
UCLASS()
class HOLOCADEEXPERIENCES_API AHoloCadePlayerController : public APlayerController
{
    GENERATED_BODY()

public:
    /** Player role (live actor vs player) */
    UPROPERTY(Replicated, BlueprintReadOnly, Category = "HoloCade")
...
```cpp
UCLASS(Blueprintable, BlueprintType, ClassGroup=(HoloCade))
class HOLOCADECORE_API UExperienceStateMachine : public UObject
{
    ...
    UFUNCTION(BlueprintCallable, Category = "HoloCade|ExperienceLoop")
